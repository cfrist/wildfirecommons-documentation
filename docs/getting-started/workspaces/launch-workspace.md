...
At this point, you should have completed the [*How to create a workspace*](./create-workspace.md) tutorial. If you haven’t done so yet, we highly recommend completing it first.
...
<img src="../images/error-401.png" style="border: 2px solid black;">
...
- Return to the Widget, and click *Install requirements.txt.*
...
- In the Widget, under *Add Selected Files*, choose:
