...
Please note: the Widget is not available within the RStudio environment. To continue using the Widget features, keep your JupyterLab session open in a separate tab or window.
