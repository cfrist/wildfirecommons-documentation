...
Participating in a Data Challenges is an excellent opportunity to collaborate on the development of scientific workflows and explore innovative solutions to complex problems.
...
After joining a data challenge, you will have access to its content and workspaces. If you’re unfamiliar with workspaces, we highly recommend reviewing this [section](../workspaces/basics.md).
